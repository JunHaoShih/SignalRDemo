...
using DataAccessLib.DAOs.Implements;
using DataAccessLib.DAOs.TypeHandlers;
...
namespace SignalRServer
{
    public class ServiceModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            Dapper.SqlMapper.AddTypeHandler(new TopicTypeHandler());
            ...
            builder.RegisterType<SqliteChatRoomDao>().As<IChatRoomDao>().WithParameter(new TypedParameter(typeof(string), sqlConnectionStr));
            builder.RegisterType<SqliteParticipantDao>().As<IParticipantDao>().WithParameter(new TypedParameter(typeof(string), sqlConnectionStr));
